...
namespace {
// ISO 15118-2 specifies a 5 s SECC PreCharge guard; deliberately relaxed to 10 s here to tolerate slower
// power supplies / EVs (intentional deviation from the standard).
