...
bool ISO15118_evImpl::handle_start_charging(types::iso15118::EnergyTransferMode& EnergyTransferMode,
    ...
    // the SECC offers). A Contract request without PnC configured falls back to EIM.
    if (SelectedPaymentOption.payment_option.has_value() and
        SelectedPaymentOption.payment_option.value() == types::iso15118::PaymentOption::Contract and
        not mod->config.enable_pnc) {
